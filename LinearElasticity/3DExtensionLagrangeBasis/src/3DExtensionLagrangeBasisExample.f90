...
PROGRAM LinearElasticity3DLagrangeBasis
  ...
  CALL CMISSBasisInterpolationXiSet(Basis(1),(/CMISSBasisLinearLagrangeInterpolation, &
  ...
  CALL CMISSBasisInterpolationXiSet(Basis(2),(/CMISSBasisLinearLagrangeInterpolation, &
    & CMISSBasisLinearLagrangeInterpolation,CMISSBasisLinearLagrangeInterpolation/),Err)
  ...
  CALL CMISSBasisInterpolationXiSet(Basis(3),(/CMISSBasisLinearLagrangeInterpolation, &
    & CMISSBasisLinearLagrangeInterpolation,CMISSBasisLinearLagrangeInterpolation/),Err)
