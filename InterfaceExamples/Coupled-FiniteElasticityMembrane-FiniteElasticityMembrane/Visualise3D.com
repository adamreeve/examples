...
gfx read node 3DCoupled-FiniteElasticityMembrane-FiniteElasticityMembrane_1.part0.exnode
gfx read element 3DCoupled-FiniteElasticityMembrane-FiniteElasticityMembrane_1.part0.exelem

# define deformed geometry
gfx define field "deformed_geom1" component Dependent1.1 Dependent1.2 Dependent1.3
...
gfx read node 3DCoupled-FiniteElasticityMembrane-FiniteElasticityMembrane_2.part0.exnode node_offset 1000
gfx read element 3DCoupled-FiniteElasticityMembrane-FiniteElasticityMembrane_2.part0.exelem node_offset 1000 element_offset 1000 line_offset 1000 face_offset 1000

# define deformed geometry
gfx define field "deformed_geom2" component Dependent2.1 Dependent2.2 Dependent2.3
