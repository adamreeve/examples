...
PROGRAM COUPLEDFINITEELASTICITYFINITEELASTICITYMEMBRANE
  ...
  CALL CMISSGeneratedMeshExtentSet(GeneratedMesh2,[0.0_CMISSDP,HEIGHT,LENGTH],Err) 
  CALL CMISSGeneratedMeshNumberOfElementsSet(GeneratedMesh2,[NUMBER_GLOBAL_Y_ELEMENTS, &
  ...
  CALL CMISSFieldComponentValuesInitialise(MaterialField2,CMISSFieldUVariableType,CMISSFieldValuesSetType,1,1.0_CMISSDP,Err)
  CALL CMISSFieldComponentValuesInitialise(MaterialField2,CMISSFieldUVariableType,CMISSFieldValuesSetType,2,0.0_CMISSDP,Err)
...
!  !######################################### START CREATING INTERFACE ##########################################
  ...
  CALL CMISSInterfaceMeshConnectivityElementNumberSet(InterfaceMeshConnectivity,1,Mesh1Index,1,Err)
  XI3 = [ 1.0_CMISSDP, 0.0_CMISSDP, 0.0_CMISSDP ]
  CALL CMISSInterfaceMeshConnectivityElementXiSet(InterfaceMeshConnectivity,1,Mesh1Index,1,1,1,XI3,Err)
  XI3 = [ 1.0_CMISSDP, 1.0_CMISSDP, 0.0_CMISSDP ]
  CALL CMISSInterfaceMeshConnectivityElementXiSet(InterfaceMeshConnectivity,1,Mesh1Index,1,2,1,XI3,Err)
  XI3 = [ 1.0_CMISSDP, 0.0_CMISSDP, 1.0_CMISSDP ]
  CALL CMISSInterfaceMeshConnectivityElementXiSet(InterfaceMeshConnectivity,1,Mesh1Index,1,3,1,XI3,Err)
  XI3 = [ 1.0_CMISSDP, 1.0_CMISSDP, 1.0_CMISSDP ]
  CALL CMISSInterfaceMeshConnectivityElementXiSet(InterfaceMeshConnectivity,1,Mesh1Index,1,4,1,XI3,Err)

  !Map the interface element to the elements in mesh 2
  CALL CMISSInterfaceMeshConnectivityElementNumberSet(InterfaceMeshConnectivity,1,Mesh2Index,1,Err)
  XI2 = [ 0.0_CMISSDP, 0.0_CMISSDP ]
  CALL CMISSInterfaceMeshConnectivityElementXiSet(InterfaceMeshConnectivity,1,Mesh2Index,1,1,1,XI2,Err)
  XI2 = [ 1.0_CMISSDP, 0.0_CMISSDP ]
  CALL CMISSInterfaceMeshConnectivityElementXiSet(InterfaceMeshConnectivity,1,Mesh2Index,1,2,1,XI2,Err)
  XI2 = [ 0.0_CMISSDP, 1.0_CMISSDP ]
  CALL CMISSInterfaceMeshConnectivityElementXiSet(InterfaceMeshConnectivity,1,Mesh2Index,1,3,1,XI2,Err)
  XI2 = [ 1.0_CMISSDP, 1.0_CMISSDP ]
  CALL CMISSInterfaceMeshConnectivityElementXiSet(InterfaceMeshConnectivity,1,Mesh2Index,1,4,1,XI2,Err)
  ...
  IF(PENALTY) THEN
    ...
    CALL CMISSFieldComponentValuesInitialise(PenaltyField,CMISSFieldUVariableType,CMISSFieldValuesSetType,1,10.0_CMISSDP,Err)
    CALL CMISSFieldComponentValuesInitialise(PenaltyField,CMISSFieldUVariableType,CMISSFieldValuesSetType,2,10.0_CMISSDP,Err)
    CALL CMISSFieldComponentValuesInitialise(PenaltyField,CMISSFieldUVariableType,CMISSFieldValuesSetType,3,10.0_CMISSDP,Err)
  ENDIF
  ...
  CALL CMISSFieldIONodesExport(Fields1,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_1_Initial","FORTRAN",Err)
  CALL CMISSFieldIOElementsExport(Fields1,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_1_Initial","FORTRAN",Err)
  ...
  CALL CMISSFieldIONodesExport(Fields2,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_2_Initial","FORTRAN",Err)
  CALL CMISSFieldIOElementsExport(Fields2,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_2_Initial","FORTRAN",Err)
  ...
  IF(UNCOUPLED.EQV..FALSE.) THEN
    ...
    CALL CMISSFieldIONodesExport(Fields3,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_Interface_Initial","FORTRAN",Err)
    CALL CMISSFieldIOElementsExport(Fields3,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_Interface_Initial","FORTRAN",Err)
  ...
  IF(UNCOUPLED.EQV..FALSE.) THEN
    ...
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,1,3, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,2,3, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,3,3, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,4,3, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)

    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,1,2, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,2,2, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,5,2, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,6,2, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)

    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,1,1, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,3,1, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,5,1, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,7,1, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)

    IF(FORCE_BC.EQV..TRUE.) THEN
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldDelUDelNVariableType,1,1,5,3, &
        & CMISSBoundaryConditionFixed,-0.2_CMISSDP,Err)
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldDelUDelNVariableType,1,1,6,3, &
        & CMISSBoundaryConditionFixed,-0.2_CMISSDP,Err)
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldDelUDelNVariableType,1,1,7,3, &
        & CMISSBoundaryConditionFixed,-0.2_CMISSDP,Err)
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldDelUDelNVariableType,1,1,8,3, &
        & CMISSBoundaryConditionFixed,-0.2_CMISSDP,Err)
    ELSE
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,5,3, &
        & CMISSBoundaryConditionFixed,0.1_CMISSDP,Err)
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,6,3, &
        & CMISSBoundaryConditionFixed,0.1_CMISSDP,Err)
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,7,3, &
        & CMISSBoundaryConditionFixed,0.1_CMISSDP,Err)
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField1,CMISSFieldUVariableType,1,1,8,3, &
        & CMISSBoundaryConditionFixed,0.1_CMISSDP,Err)
    ENDIF
    ...
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,1,3, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,2,3, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)

    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,1,2, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,3,2, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)

    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,LagrangeField,CMISSFieldUVariableType,1,1,1,3, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,LagrangeField,CMISSFieldUVariableType,1,1,2,3, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,LagrangeField,CMISSFieldUVariableType,1,1,1,2, &
      & CMISSBoundaryConditionFixed,0.0_CMISSDP,Err)
  ...
  ELSE
    ...
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,1,1, &
      & CMISSBoundaryConditionFixed, &
      & 0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,2,1, &
      & CMISSBoundaryConditionFixed, &
      & 0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,3,1, &
      & CMISSBoundaryConditionFixed, &
      & 0.0_CMISSDP,Err)
    CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,4,1, &
      & CMISSBoundaryConditionFixed, &
      & 0.0_CMISSDP,Err)

    IF(FORCE_BC.EQV..TRUE.) THEN
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldDelUDelNVariableType,1,1,3,3, &
        & CMISSBoundaryConditionFixed, &
        & -0.2_CMISSDP,Err)
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldDelUDelNVariableType,1,1,4,3, &
        & CMISSBoundaryConditionFixed, &
        & -0.2_CMISSDP,Err)
    ELSE
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,3,3, &
        & CMISSBoundaryConditionFixed, &
        & 0.1_CMISSDP,Err)
      CALL CMISSBoundaryConditionsAddNode(BoundaryConditions,DependentField2,CMISSFieldUVariableType,1,1,4,3, &
        & CMISSBoundaryConditionFixed, &
        & 0.1_CMISSDP,Err)
    ENDIF
  ENDIF
  ...
  CALL CMISSFieldsTypeInitialise(Fields1,Err)
  CALL CMISSFieldsTypeCreate(Region1,Fields1,Err)
  CALL CMISSFieldIONodesExport(Fields1,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_1","FORTRAN",Err)
  CALL CMISSFieldIOElementsExport(Fields1,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_1","FORTRAN",Err)
  CALL CMISSFieldsTypeFinalise(Fields1,Err)
  CALL CMISSFieldsTypeInitialise(Fields2,Err)
  CALL CMISSFieldsTypeCreate(Region2,Fields2,Err)
  CALL CMISSFieldIONodesExport(Fields2,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_2","FORTRAN",Err)
  CALL CMISSFieldIOElementsExport(Fields2,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_2","FORTRAN",Err)
  CALL CMISSFieldsTypeFinalise(Fields2,Err)
  IF(UNCOUPLED.EQV..FALSE.) THEN
    CALL CMISSFieldsTypeInitialise(Fields3,Err)
    CALL CMISSFieldsTypeCreate(Interface,Fields3,Err)
    CALL CMISSFieldIONodesExport(Fields3,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_Interface","FORTRAN",Err)
    CALL CMISSFieldIOElementsExport(Fields3,"3DCoupled-FiniteElasticity-FiniteElasticityMembrane_Interface","FORTRAN",Err)
    CALL CMISSFieldsTypeFinalise(Fields3,Err)
  ENDIF
