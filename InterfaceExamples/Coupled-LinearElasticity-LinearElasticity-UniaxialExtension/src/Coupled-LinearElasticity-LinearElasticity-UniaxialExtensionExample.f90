...
PROGRAM COUPLED_LINEARELASTICITY_LINEARELASTICITY
  ...
  IF(PENALTY) THEN
    ...
    CALL CMISSFieldComponentValuesInitialise(PenaltyField,CMISSFieldUVariableType,CMISSFieldValuesSetType,1,1000.0_CMISSDP,Err)
    CALL CMISSFieldComponentValuesInitialise(PenaltyField,CMISSFieldUVariableType,CMISSFieldValuesSetType,2,1000.0_CMISSDP,Err)
    IF(NUMBER_GLOBAL_Z_ELEMENTS/=0) THEN
      CALL CMISSFieldComponentValuesInitialise(PenaltyField,CMISSFieldUVariableType,CMISSFieldValuesSetType,3,1000.0_CMISSDP,Err)
    ENDIF
  ENDIF
