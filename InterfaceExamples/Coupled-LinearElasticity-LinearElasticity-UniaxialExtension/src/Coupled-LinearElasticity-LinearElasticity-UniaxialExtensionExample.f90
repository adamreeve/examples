...
!> \example InterfaceExamples/Coupled-LinearElasticity-LinearElasticity/src/Coupled-LinearElasticity-LinearElasticity-UniaxialExtension.f90
...
PROGRAM COUPLED_LINEARELASTICITY_LINEARELASTICITY
  ...
  LOGICAL :: UNCOUPLED,FORCE_BC,PENALTY
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    ...
    CALL CMISSBasis_InterpolationXiSet(Basis1,[INTERPOLATION_TYPE,INTERPOLATION_TYPE],Err)
    CALL CMISSBasis_QuadratureNumberOfGaussXiSet(Basis1,[NUMBER_OF_GAUSS_XI,NUMBER_OF_GAUSS_XI],Err)
  ELSE
  ...
  ELSE
    ...
    CALL CMISSBasis_InterpolationXiSet(Basis2,[INTERPOLATION_TYPE,INTERPOLATION_TYPE,INTERPOLATION_TYPE],Err)
    CALL CMISSBasis_QuadratureNumberOfGaussXiSet(Basis2,[NUMBER_OF_GAUSS_XI,NUMBER_OF_GAUSS_XI, &
      & NUMBER_OF_GAUSS_XI],Err)
  ENDIF
  !Finish the creation of the basis
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    CALL CMISSGeneratedMesh_OriginSet(GeneratedMesh1,[0.0_CMISSDP,0.0_CMISSDP],Err) 
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS/=0) THEN
    CALL CMISSField_ComponentMeshComponentSet(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,4,1,Err)
    CALL CMISSField_ComponentMeshComponentSet(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,5,1,Err)
    CALL CMISSField_ComponentMeshComponentSet(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,6,1,Err)
  ENDIF
  !Finish creating the first field
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS/=0) THEN
    CALL CMISSField_ComponentMeshComponentSet(MaterialField2,CMISS_FIELD_U_VARIABLE_TYPE,4,1,Err)
    CALL CMISSField_ComponentMeshComponentSet(MaterialField2,CMISS_FIELD_U_VARIABLE_TYPE,5,1,Err)
    CALL CMISSField_ComponentMeshComponentSet(MaterialField2,CMISS_FIELD_U_VARIABLE_TYPE,6,1,Err)
  ENDIF
  !Finish creating the first field
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 1,1.0_CMISSDP,Err) !thickness
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 2,200.0_CMISSDP,Err) !E
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 3,0.25_CMISSDP,Err) !v
  ELSE
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 1,200.0_CMISSDP,Err) !E1
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 2,200.0_CMISSDP,Err) !E2
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 3,200.0_CMISSDP,Err) !E3
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 4,0.25_CMISSDP,Err) !v13
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 5,0.25_CMISSDP,Err) !v23
    CALL CMISSField_ComponentValuesInitialise(MaterialField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 6,0.25_CMISSDP,Err) !v12
  ENDIF
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    CALL CMISSEquationsSet_CreateStart(EquationsSet1UserNumber,Region1,GeometricField1,CMISS_EQUATIONS_SET_ELASTICITY_CLASS, &
      & CMISS_EQUATIONS_SET_LINEAR_ELASTICITY_TYPE,CMISS_EQUATIONS_SET_TWO_DIMENSIONAL_PLANE_STRESS_SUBTYPE, &
      & EquationsSetField1UserNumber,EquationsSetField1,EquationsSet1,Err)
  ELSE
    CALL CMISSEquationsSet_CreateStart(EquationsSet1UserNumber,Region1,GeometricField1,CMISS_EQUATIONS_SET_ELASTICITY_CLASS, &
      & CMISS_EQUATIONS_SET_LINEAR_ELASTICITY_TYPE,CMISS_EQUATIONS_SET_THREE_DIMENSIONAL_SUBTYPE,EquationsSetField1UserNumber,&
  ...
  !Set the equations set to be a Finite Elasticity problem
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    CALL CMISSEquationsSet_CreateStart(EquationsSet2UserNumber,Region2,GeometricField2,CMISS_EQUATIONS_SET_ELASTICITY_CLASS, &
      & CMISS_EQUATIONS_SET_LINEAR_ELASTICITY_TYPE,CMISS_EQUATIONS_SET_TWO_DIMENSIONAL_PLANE_STRESS_SUBTYPE, &
      & EquationsSetField2UserNumber,EquationsSetField2,EquationsSet2,Err)
  ELSE
    CALL CMISSEquationsSet_CreateStart(EquationsSet2UserNumber,Region2,GeometricField2,CMISS_EQUATIONS_SET_ELASTICITY_CLASS, &
      & CMISS_EQUATIONS_SET_LINEAR_ELASTICITY_TYPE,CMISS_EQUATIONS_SET_THREE_DIMENSIONAL_SUBTYPE,EquationsSetField2UserNumber,&
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN  
    !Set the basis to be a linear Lagrange basis
    CALL CMISSBasis_NumberOfXiSet(InterfaceMappingBasis,1,Err)
    CALL CMISSBasis_InterpolationXiSet(InterfaceMappingBasis,[CMISS_BASIS_LINEAR_LAGRANGE_INTERPOLATION],Err)
  ELSE
    !Set the basis to be a bilinear Lagrange basis
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    DO y_element_idx=1,NUMBER_GLOBAL_Y_ELEMENTS
      ...
      CALL CMISSInterfaceMeshConnectivity_ElementNumberSet(InterfaceMeshConnectivity,y_element_idx,Mesh1Index, &
        y_element_idx*NUMBER_GLOBAL_X_ELEMENTS,Err)
      XI2 = [ 1.0_CMISSDP, 0.0_CMISSDP ]
      CALL CMISSInterfaceMeshConnectivity_ElementXiSet(InterfaceMeshConnectivity,y_element_idx,Mesh1Index, &
      ...
      CALL CMISSInterfaceMeshConnectivity_ElementNumberSet(InterfaceMeshConnectivity,y_element_idx,Mesh2Index, &
      ...
      DO mesh_local_y_node = 1,NUMBER_OF_NODE_XI-1
        ...
        CALL CMISSInterfaceMeshConnectivity_ElementXiSet(InterfaceMeshConnectivity,y_element_idx,Mesh2Index, &
  ...
  IF(PENALTY) THEN
    ...
    CALL CMISSField_ComponentValuesInitialise(PenaltyField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 1,1000.0_CMISSDP,Err)
    CALL CMISSField_ComponentValuesInitialise(PenaltyField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 2,1000.0_CMISSDP,Err)
    IF(NUMBER_GLOBAL_Z_ELEMENTS/=0) THEN
      CALL CMISSField_ComponentValuesInitialise(PenaltyField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
        & 3,1000.0_CMISSDP,Err)
    ENDIF
  ENDIF
  ...
  CALL CMISSProblem_SpecificationSet(CoupledProblem,CMISS_PROBLEM_ELASTICITY_CLASS, &
    & CMISS_PROBLEM_LINEAR_ELASTICITY_TYPE,CMISS_PROBLEM_NO_SUBTYPE,Err)
  ...
  CALL CMISSProblem_SolverGet(CoupledProblem,CMISS_CONTROL_LOOP_NODE,1,LinearSolver,Err)
  ...
  !CALL CMISSSolver_LinearIterativeRelativeToleranceSet(LinearSolver,1.0E-10_CMISSDP,Err)
  !CALL CMISSSolver_LinearIterativeAbsoluteToleranceSet(LinearSolver,1.0E-10_CMISSDP,Err)
  ...
  CALL CMISSSolver_Initialise(LinearSolver,Err)
  CALL CMISSSolverEquations_Initialise(LinearSolverEquations,Err)
  CALL CMISSProblem_SolverEquationsCreateStart(CoupledProblem,Err)
  !Get the solve equations
  CALL CMISSProblem_SolverGet(CoupledProblem,CMISS_CONTROL_LOOP_NODE,1,LinearSolver,Err)
  CALL CMISSSolver_SolverEquationsGet(LinearSolver,LinearSolverEquations,Err)
  !Set the solver equations sparsity
  !CALL CMISSSolverEquations_SparsityTypeSet(LinearSolverEquations,CMISS_SOLVER_SPARSE_MATRICES,Err)
  CALL CMISSSolverEquations_SparsityTypeSet(LinearSolverEquations,CMISS_SOLVER_FULL_MATRICES,Err)  
  !Add in the first equations set
  CALL CMISSSolverEquations_EquationsSetAdd(LinearSolverEquations,EquationsSet1,EquationsSet1Index,Err)
  !Add in the second equations set
  CALL CMISSSolverEquations_EquationsSetAdd(LinearSolverEquations,EquationsSet2,EquationsSet2Index,Err)
  !Add in the interface condition
  IF(UNCOUPLED.EQV..FALSE.) THEN
    CALL CMISSSolverEquations_InterfaceConditionAdd(LinearSolverEquations,InterfaceCondition,InterfaceConditionIndex,Err)
  ENDIF
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    ...
    CALL CMISSFields_NodesExport(Fields1,"2DCoupled-LinearElasticity-LinearElasticity_1_Initial","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields1,"2DCoupled-LinearElasticity-LinearElasticity_1_Initial","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields1,Err)
    CALL CMISSFields_Initialise(Fields2,Err)
    CALL CMISSFields_Create(Region2,Fields2,Err)
    CALL CMISSFields_NodesExport(Fields2,"2DCoupled-LinearElasticity-LinearElasticity_2_Initial","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields2,"2DCoupled-LinearElasticity-LinearElasticity_2_Initial","FORTRAN",Err)
    ...
    IF(UNCOUPLED.EQV..FALSE.) THEN
      ...
      CALL CMISSFields_NodesExport(Fields3,"2DCoupled-LinearElasticity-LinearElasticity_Interface_Initial","FORTRAN",Err)
      CALL CMISSFields_ElementsExport(Fields3,"2DCoupled-LinearElasticity-LinearElasticity_Interface_Initial","FORTRAN",Err)
      CALL CMISSFields_Finalise(Fields3,Err)
    ENDIF
  ELSE
    CALL CMISSFields_Initialise(Fields1,Err)
    CALL CMISSFields_Create(Region1,Fields1,Err)
    CALL CMISSFields_NodesExport(Fields1,"3DCoupled-LinearElasticity-LinearElasticity_1_Initial","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields1,"3DCoupled-LinearElasticity-LinearElasticity_1_Initial","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields1,Err)
    CALL CMISSFields_Initialise(Fields2,Err)
    CALL CMISSFields_Create(Region2,Fields2,Err)
    CALL CMISSFields_NodesExport(Fields2,"3DCoupled-LinearElasticity-LinearElasticity_2_Initial","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields2,"3DCoupled-LinearElasticity-LinearElasticity_2_Initial","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields2,Err)
    IF(UNCOUPLED.EQV..FALSE.) THEN
      CALL CMISSFields_Initialise(Fields3,Err)
      CALL CMISSFields_Create(Interface,Fields3,Err)
      CALL CMISSFields_NodesExport(Fields3,"3DCoupled-LinearElasticity-LinearElasticity_Interface_Initial","FORTRAN",Err)
      CALL CMISSFields_ElementsExport(Fields3,"3DCoupled-LinearElasticity-LinearElasticity_Interface_Initial","FORTRAN",Err)
      CALL CMISSFields_Finalise(Fields3,Err)
    ENDIF
  ENDIF
  ...
  CALL CMISSSolverEquations_BoundaryConditionsCreateStart(LinearSolverEquations,BoundaryConditions,Err)
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    ...
    IF(UNCOUPLED.EQV..FALSE.) THEN
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      IF(FORCE_BC.EQV..TRUE.) THEN
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,2,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,4,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
      ELSE
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,4,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,2, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.0_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,2, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.0_CMISSDP,Err)
      ENDIF
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,LagrangeField,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
    ELSE
      !============================================================================================================================
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,4,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)

      IF(FORCE_BC.EQV..TRUE.) THEN
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,3,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
      ELSE
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
      ENDIF
      ...
      !Start the creation of the solver equations boundary conditions for the second region
      PRINT *, ' == >> CREATING BOUNDARY CONDITIONS(2) << == '
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,4,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)

      IF(FORCE_BC.EQV..TRUE.) THEN
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,3,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
      ELSE
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
      ENDIF
  ...
  ELSE
    ...
    IF(UNCOUPLED.EQV..FALSE.) THEN
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,5,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,7,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,5,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)

      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,4,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      IF(FORCE_BC.EQV..TRUE.) THEN
        ...
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,8,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
      ELSE
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,1, &
        ...
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,8,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
      ENDIF
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,5,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)

      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,4,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,LagrangeField,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,LagrangeField,CMISS_FIELD_U_VARIABLE_TYPE,1,1,2,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,LagrangeField,CMISS_FIELD_U_VARIABLE_TYPE,1,1,1,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,LagrangeField,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
    ELSE
      !============================================================================================================================
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,7,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,10,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,7,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,8,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,9,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,4,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,5,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      IF(FORCE_BC.EQV..TRUE.) THEN
        ...
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,9,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,12,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
      ELSE
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,1, &
        ...
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,9,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,1,1,12,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
      ENDIF
      !Start the creation of the solver equations boundary conditions for the second region
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,4,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,7,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,10,1, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,7,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,8,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,9,2, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,4,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,5,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,3, &
        & CMISS_BOUNDARY_CONDITION_FIXED, &
        & 0.0_CMISSDP,Err)
      ...
      IF(FORCE_BC.EQV..TRUE.) THEN
        ...
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,9,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,1,12,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & -2.5_CMISSDP,Err)
      ELSE
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,3,1, &
        ...
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,6,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,9,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
        CALL CMISSBoundaryConditions_SetNode(BoundaryConditions,DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,1,1,12,1, &
          & CMISS_BOUNDARY_CONDITION_FIXED, &
          & 0.1_CMISSDP,Err)
      ENDIF
    ENDIF
  ...
  CALL CMISSSolverEquations_BoundaryConditionsCreateFinish(LinearSolverEquations,Err)
  ...
  DO node_idx=1,(NUMBER_GLOBAL_X_ELEMENTS+1)*(NUMBER_GLOBAL_Y_ELEMENTS+1)*(NUMBER_GLOBAL_Z_ELEMENTS+1)
    DO component_idx=1,GeometricField1NumberOfComponents
      CALL CMISSField_ParameterSetGetNode(GeometricField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
        & component_idx,Value1,Err)
      CALL CMISSField_ParameterSetGetNode(DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
        & component_idx,Value2,Err)
      CALL CMISSField_ParameterSetAddNode(DependentField1,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
  ...
  DO node_idx=1,(NUMBER_GLOBAL_X_ELEMENTS+1)*(NUMBER_GLOBAL_Y_ELEMENTS+1)*(NUMBER_GLOBAL_Z_ELEMENTS+1)
    DO component_idx=1,GeometricField1NumberOfComponents
      CALL CMISSField_ParameterSetGetNode(GeometricField2,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
        & component_idx,Value1,Err)
      CALL CMISSField_ParameterSetGetNode(DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
        & component_idx,Value2,Err)
      CALL CMISSField_ParameterSetAddNode(DependentField2,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
        & component_idx,Value1+Value2,Err)
    ENDDO
  ENDDO
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
    CALL CMISSFields_Initialise(Fields1,Err)
    CALL CMISSFields_Create(Region1,Fields1,Err)
    CALL CMISSFields_NodesExport(Fields1,"2DCoupled-LinearElasticity-LinearElasticity_1","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields1,"2DCoupled-LinearElasticity-LinearElasticity_1","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields1,Err)
    CALL CMISSFields_Initialise(Fields2,Err)
    CALL CMISSFields_Create(Region2,Fields2,Err)
    CALL CMISSFields_NodesExport(Fields2,"2DCoupled-LinearElasticity-LinearElasticity_2","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields2,"2DCoupled-LinearElasticity-LinearElasticity_2","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields2,Err)
    IF(UNCOUPLED.NEQV..TRUE.) THEN
      CALL CMISSFields_Initialise(Fields3,Err)
      CALL CMISSFields_Create(Interface,Fields3,Err)
      CALL CMISSFields_NodesExport(Fields3,"2DCoupled-LinearElasticity-LinearElasticity_Interface","FORTRAN",Err)
      CALL CMISSFields_ElementsExport(Fields3,"2DCoupled-LinearElasticity-LinearElasticity_Interface","FORTRAN",Err)
      CALL CMISSFields_Finalise(Fields3,Err)
    ENDIF
  ELSE
    CALL CMISSFields_Initialise(Fields1,Err)
    CALL CMISSFields_Create(Region1,Fields1,Err)
    CALL CMISSFields_NodesExport(Fields1,"3DCoupled-LinearElasticity-LinearElasticity_1","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields1,"3DCoupled-LinearElasticity-LinearElasticity_1","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields1,Err)
    CALL CMISSFields_Initialise(Fields2,Err)
    CALL CMISSFields_Create(Region2,Fields2,Err)
    CALL CMISSFields_NodesExport(Fields2,"3DCoupled-LinearElasticity-LinearElasticity_2","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields2,"3DCoupled-LinearElasticity-LinearElasticity_2","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields2,Err)
    IF(UNCOUPLED.NEQV..TRUE.) THEN
      CALL CMISSFields_Initialise(Fields3,Err)
      CALL CMISSFields_Create(Interface,Fields3,Err)
      CALL CMISSFields_NodesExport(Fields3,"3DCoupled-LinearElasticity-LinearElasticity_Interface","FORTRAN",Err)
      CALL CMISSFields_ElementsExport(Fields3,"3DCoupled-LinearElasticity-LinearElasticity_Interface","FORTRAN",Err)
      CALL CMISSFields_Finalise(Fields3,Err)
    ENDIF
  ENDIF
