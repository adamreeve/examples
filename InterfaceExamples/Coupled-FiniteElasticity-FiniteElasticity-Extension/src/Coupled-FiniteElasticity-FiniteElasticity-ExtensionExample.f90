...
PROGRAM COUPLEDFINITEELASTICITYFINITEELASTICITY
  ...
  CALL CMISSFieldComponentValuesInitialise(MaterialField1,CMISSFieldUVariableType,CMISSFieldValuesSetType,2,0.1_CMISSDP,Err)
  IF (INCOMPRESSIBLE.eqv..FALSE.) THEN
  ...
  CALL CMISSFieldComponentValuesInitialise(MaterialField2,CMISSFieldUVariableType,CMISSFieldValuesSetType,2,0.1_CMISSDP,Err)
  IF (INCOMPRESSIBLE.eqv..FALSE.) THEN
  ...
  IF(PENALTY) THEN
    ...
    CALL CMISSFieldComponentValuesInitialise(PenaltyField,CMISSFieldUVariableType,CMISSFieldValuesSetType,3,10000.0_CMISSDP,Err)
  ENDIF
