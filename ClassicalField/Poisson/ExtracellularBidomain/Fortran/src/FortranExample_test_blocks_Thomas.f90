...
!------------------------------------------------------------------------- 
  ...
  INTEGER(CMFEIntg) :: TotalNumberOfElements,TotalNumberOfNodes,TotalNumberOfNodesMuscle
...
!--------------------------------------------------------------------------------------------------------------------------------
  ...
  ELSE
    ...
    NUMBER_GLOBAL_X_ELEMENTS=87
    NUMBER_GLOBAL_Y_ELEMENTS=8
    NUMBER_GLOBAL_Z_ELEMENTS=7

!    TotalNumberOfNodesMuscle=(NUMBER_GLOBAL_X_ELEMENTS+1)*(NUMBER_GLOBAL_Y_ELEMENTS+1)*(4+1)
...
! SOURCE
  ...
  !initialise source values to -82.0
...
CONTAINS
  ...
  !use for several blocks in y- and z-direction
  !-------------------------------------------------------------------------------------- 
  ...
  SUBROUTINE READ_ELEMENTNODES(fp,totalnumberofelements,elemtopology)
    ...
    INTEGER(CMFEIntg) :: number_of_elems,number_of_nodes
    ...
    READ(fp,*) number_of_elems,number_of_nodes
...
!    ENDDO
  ...
  !--------------------------------------------------------------------------------------
  !Subroutine to create the mesh by the given geometry (only for one block)
  !-------------------------------------------------------------------------------------- 
