...
!--------------------------------------------------------------------------------------------------------------------------------
  ...
  REAL(CMFEDP), PARAMETER :: HEIGHT=1.0_CMFEDP  ! y-direction
  REAL(CMFEDP), PARAMETER :: LENGTH=1.0_CMFEDP  ! z-direction
...
!    ENDDO
  ...
  SUBROUTINE READ_EXNODE(fp,totalnumberofnodes,nodecoords)
    ...
    REAL(CMFEDP) :: x,y,z,f1,f2,f3,Vm,phi,delphideln
