...
!--------------------------------------------------------------------------------------------------------------------------------
  ...
  REAL(CMFEDP), PARAMETER :: HEIGHT=1.8_CMFEDP  ! y-direction
  REAL(CMFEDP), PARAMETER :: LENGTH=2.0_CMFEDP/3.0_CMFEDP  ! z-direction
...
!-------------------------------------------------------------------------
  ...
  !Set the (first node to 0.0 and the) last node to 0.0
  FirstNodeNumber=1
  CALL cmfe_Nodes_Initialise(Nodes,Err)
  CALL cmfe_Region_NodesGet(Region,Nodes,Err)
