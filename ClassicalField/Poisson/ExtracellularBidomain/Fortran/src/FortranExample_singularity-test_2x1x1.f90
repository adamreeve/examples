...
!------------------------------------------------------------------------- 
  ...
  REAL(CMFEDP) :: FibreFieldAngle(3),phi,sumphi,meanphi
  ...
  REAL(CMFEDP),DIMENSION(:,:),ALLOCATABLE :: NodeCoords!,NodeCoordsExtra
...
!-------------------------------------------------------------------------
  ...
  INTEGER(CMFEIntg) :: FirstNodeDomain,LastNodeDomain,NodeDomain,xNodeDomain,yNodeDomain,zeroNodeDomain
...
!--------------------------------------------------------------------------------------------------------------------------------
  ...
  ELSE
    ...
    NUMBER_GLOBAL_X_ELEMENTS=48
    NUMBER_GLOBAL_Y_ELEMENTS=8
    NUMBER_GLOBAL_Z_ELEMENTS=3

    NUMBER_GLOBAL_Z_ELEMENTS_MUSCLE=2
...
!  CALL cmfe_Mesh_NumberOfElementsSet(Mesh,TotalNumberOfElements+4,Err)    
  
  !Define nodes for the mesh
  CALL cmfe_Nodes_Initialise(Nodes,Err)
  CALL cmfe_Nodes_CreateStart(Region,TotalNumberOfNodes,Nodes,Err)
!  CALL cmfe_Nodes_CreateStart(Region,TotalNumberOfNodes+16,Nodes,Err)
...
!  OPEN(UNIT=2,FILE="./data/singularity_test_elems_2x1x1/mesh.txt")
  OPEN(UNIT=2,FILE="../inputdata/singularity_test_elems_2x1x1/mesh.txt")
...
!  !! TODO: ADD 4 ELEMENTS AND THEIR NODES
!  CALL cmfe_MeshElements_NodesSet(Elements,TotalNumberOfElements+1,[TotalNumberOfNodes+1,TotalNumberOfNodes+2, &
!    & TotalNumberOfNodes+3,TotalNumberOfNodes+4,1,2,NUMBER_GLOBAL_X_ELEMENTS+2,NUMBER_GLOBAL_X_ELEMENTS+3],Err)
!  CALL cmfe_MeshElements_NodesSet(Elements,TotalNumberOfElements+2,[TotalNumberOfNodes+5,TotalNumberOfNodes+6, &
!    & TotalNumberOfNodes+7,TotalNumberOfNodes+8,TotalNumberOfNodes+1,TotalNumberOfNodes+2,TotalNumberOfNodes+3, &
!    & TotalNumberOfNodes+4],Err)
!  CALL cmfe_MeshElements_NodesSet(Elements,TotalNumberOfElements+3,[TotalNumberOfNodes+9,TotalNumberOfNodes+10, &
!    & TotalNumberOfNodes+11,TotalNumberOfNodes+12,TotalNumberOfNodes+5,TotalNumberOfNodes+6,TotalNumberOfNodes+7, &
!    & TotalNumberOfNodes+8],Err)
!  CALL cmfe_MeshElements_NodesSet(Elements,TotalNumberOfElements+4,[TotalNumberOfNodes+13,TotalNumberOfNodes+14, &
!    & TotalNumberOfNodes+15,TotalNumberOfNodes+16,TotalNumberOfNodes+9,TotalNumberOfNodes+10,TotalNumberOfNodes+11, &
!    & TotalNumberOfNodes+12],Err)      
...
!  OPEN(UNIT=4,FILE="./data/singularity_test_elems_2x1x1/MainTime_M_2_0.part0.exnode")
  OPEN(UNIT=4,FILE="../inputdata/singularity_test_elems_2x1x1/MainTime_M_2_0.part0.exnode")
...
!  !! TODO: initialise the nodal coordinates of the new extra elements

!  NodeCoordsExtra(1,:)=[0.0_CMFEDP,0.05_CMFEDP,1.85_CMFEDP]!-0.15_CMFEDP]
!  NodeCoordsExtra(2,:)=[0.0416667_CMFEDP,0.05_CMFEDP,1.85_CMFEDP]!-0.15_CMFEDP]
!  NodeCoordsExtra(3,:)=[0.0_CMFEDP,0.15_CMFEDP,1.85_CMFEDP]!-0.15_CMFEDP]
!  NodeCoordsExtra(4,:)=[0.0416667_CMFEDP,0.15_CMFEDP,1.85_CMFEDP]!-0.15_CMFEDP]

!  NodeCoordsExtra(5,:)=[0.0_CMFEDP,0.05_CMFEDP,2.25_CMFEDP]!-0.35_CMFEDP]
!  NodeCoordsExtra(6,:)=[0.0416667_CMFEDP,0.05_CMFEDP,1.85_CMFEDP]!-0.35_CMFEDP]
!  NodeCoordsExtra(7,:)=[0.0_CMFEDP,0.15_CMFEDP,2.25_CMFEDP]!-0.35_CMFEDP]
!  NodeCoordsExtra(8,:)=[0.0416667_CMFEDP,0.15_CMFEDP,2.25_CMFEDP]!-0.35_CMFEDP]
!  
!  NodeCoordsExtra(9,:)=[0.0_CMFEDP,0.05_CMFEDP,2.65_CMFEDP]!-0.55_CMFEDP]
!  NodeCoordsExtra(10,:)=[0.0416667_CMFEDP,0.05_CMFEDP,2.65_CMFEDP]!-0.55_CMFEDP]
!  NodeCoordsExtra(11,:)=[0.0_CMFEDP,0.15_CMFEDP,2.65_CMFEDP]!-0.55_CMFEDP]
!  NodeCoordsExtra(12,:)=[0.0416667_CMFEDP,0.15_CMFEDP,2.65_CMFEDP]!-0.55_CMFEDP]
!  
!  NodeCoordsExtra(13,:)=[0.0_CMFEDP,0.05_CMFEDP,3.05_CMFEDP]!-0.75_CMFEDP]
!  NodeCoordsExtra(14,:)=[0.0416667_CMFEDP,0.05_CMFEDP,3.05_CMFEDP]!-0.75_CMFEDP]
!  NodeCoordsExtra(15,:)=[0.0_CMFEDP,0.15_CMFEDP,3.05_CMFEDP]!-0.75_CMFEDP]
!  NodeCoordsExtra(16,:)=[0.0416667_CMFEDP,0.15_CMFEDP,3.05_CMFEDP]!-0.75_CMFEDP]      
!        
!  DO node_idx=TotalNumberOfNodes+1,TotalNumberOfNodes+16
!    CALL cmfe_Decomposition_NodeDomainGet(Decomposition,node_idx,1,NodeDomain,Err)
!    IF(NodeDomain==ComputationalNodeNumber) THEN
!      CALL cmfe_Field_ParameterSetUpdateNode(GeometricField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1, &
!        & node_idx,1,NodeCoordsExtra(node_idx-TotalNumberOfNodes,1),Err) !x-positon
!      CALL cmfe_Field_ParameterSetUpdateNode(GeometricField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1, &
!        & node_idx,2,NodeCoordsExtra(node_idx-TotalNumberOfNodes,2),Err) !y-position
!      CALL cmfe_Field_ParameterSetUpdateNode(GeometricField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1, &
!        & node_idx,3,NodeCoordsExtra(node_idx-TotalNumberOfNodes,3),Err) !z-position
!    ENDIF
!  ENDDO      
...
! MATERIAL  
  ...
  !"sigma=sigma_i+sigma_e" => set sigma_i default to 0, thus sigma=sigma_e
    DO elem_idx=TotalNumberOfElementsMuscle+1,TotalNumberOfElements!+4 !also for 4 elements for b.c.
    IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN
      !sigma_i --> set to 0          
...
!-------------------------------------------------------------------------
  ...
  !! TODO set the new "cornernode" to 0.0
...
!  CALL cmfe_Decomposition_NodeDomainGet(Decomposition,65106,1,yNodeDomain,Err)
!  CALL cmfe_Decomposition_NodeDomainGet(Decomposition,20301,1,zeroNodeDomain,Err)
!  CALL cmfe_Decomposition_NodeDomainGet(Decomposition,20445,1,xNodeDomain,Err)
...
!      & CMFE_BOUNDARY_CONDITION_FIXED,0.0_CMFEDP,Err)
!!    CALL cmfe_BoundaryConditions_SetNode(BoundaryConditions,DependentField,CMFE_FIELD_U_VARIABLE_TYPE,1,1,LastNodeNumber-3,1, &
!!      & CMFE_BOUNDARY_CONDITION_FIXED,0.0_CMFEDP,Err)
!  ENDIF
!  IF(yNodeDomain==ComputationalNodeNumber) THEN
!    CALL cmfe_BoundaryConditions_SetNode(BoundaryConditions,DependentField,CMFE_FIELD_U_VARIABLE_TYPE,1,1,65106,1, &
!      & CMFE_BOUNDARY_CONDITION_FIXED,0.0_CMFEDP,Err)
!  ENDIF
!  IF(zeroNodeDomain==ComputationalNodeNumber) THEN
!    CALL cmfe_BoundaryConditions_SetNode(BoundaryConditions,DependentField,CMFE_FIELD_U_VARIABLE_TYPE,1,1,20301,1, &
!      & CMFE_BOUNDARY_CONDITION_FIXED,0.0_CMFEDP,Err)
!  ENDIF
!  IF(xNodeDomain==ComputationalNodeNumber) THEN
!    CALL cmfe_BoundaryConditions_SetNode(BoundaryConditions,DependentField,CMFE_FIELD_U_VARIABLE_TYPE,1,1,20445,1, &
!      & CMFE_BOUNDARY_CONDITION_FIXED,0.0_CMFEDP,Err)
!  ENDIF    
...
!    name_part1="./data/singularity_test_elems_2x1x1/MainTime_M_2_"
    name_part1="../inputdata/singularity_test_elems_2x1x1/MainTime_M_2_"
...
!            & 1,NodeCoords(node_idx,1),1,NodeCoords(node_idx,5),Err)
    ...
    !TODO: calculate mean of solution and substract from each node (instead of dirichlet bc)
    ...
    meanphi=sumphi/TotalNumberOfNodes
    WRITE(*,*) meanphi
    
    DO node_idx=1,TotalNumberOfNodes    
      CALL cmfe_Field_ParameterSetAddNode(DependentField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1,node_idx,1, &
        & -meanphi,Err)
    ENDDO
...
CONTAINS
  ...
  !--------------------------------------------------------------------------------------
  !Subroutine to read in mesh information from mesh.txt (created by gen_elem.f90)
  !-------------------------------------------------------------------------------------- 
  ...
  SUBROUTINE READ_ELEMENTNODES(fp,totalnumberofelements,elemtopology)
    ...
    INTEGER(CMFEIntg) :: total_num_elem,total_num_nodes
    ...
    READ(fp,*) total_num_elem,total_num_nodes
