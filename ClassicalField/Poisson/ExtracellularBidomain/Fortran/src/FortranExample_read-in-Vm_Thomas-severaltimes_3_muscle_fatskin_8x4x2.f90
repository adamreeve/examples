...
!------------------------------------------------------------------------- 
  ...
  REAL(CMFEDP),DIMENSION(:,:),ALLOCATABLE :: NodeCoords,NodeCoordsMuscle,NodeCoordsExtra
...
!--------------------------------------------------------------------------------------------------------------------------------
  ...
  ELSE
    ...
    NUMBER_GLOBAL_X_ELEMENTS=232
    NUMBER_GLOBAL_Y_ELEMENTS=39
    NUMBER_GLOBAL_Z_ELEMENTS=19

    NUMBER_GLOBAL_Z_ELEMENTS_MUSCLE=17
...
!        & NodeCoords(node_idx,1),3,NodeCoords(node_idx,4),Err) !z-position
  ...
  NodeCoordsExtra(1,:)=[0.0_CMFEDP,0.05_CMFEDP,-0.1_CMFEDP]
  NodeCoordsExtra(2,:)=[0.0344828_CMFEDP,0.05_CMFEDP,-0.1_CMFEDP]
  NodeCoordsExtra(3,:)=[0.0_CMFEDP,0.15_CMFEDP,-0.1_CMFEDP]
  NodeCoordsExtra(4,:)=[0.0344828_CMFEDP,0.15_CMFEDP,-0.1_CMFEDP]

  NodeCoordsExtra(5,:)=[0.0_CMFEDP,0.05_CMFEDP,-0.3_CMFEDP]
  NodeCoordsExtra(6,:)=[0.0344828_CMFEDP,0.05_CMFEDP,-0.3_CMFEDP]
  NodeCoordsExtra(7,:)=[0.0_CMFEDP,0.15_CMFEDP,-0.3_CMFEDP]
  NodeCoordsExtra(8,:)=[0.0344828_CMFEDP,0.15_CMFEDP,-0.3_CMFEDP]
  
  NodeCoordsExtra(9,:)=[0.0_CMFEDP,0.05_CMFEDP,-0.5_CMFEDP]
  NodeCoordsExtra(10,:)=[0.0344828_CMFEDP,0.05_CMFEDP,-0.5_CMFEDP]
  NodeCoordsExtra(11,:)=[0.0_CMFEDP,0.15_CMFEDP,-0.5_CMFEDP]
  NodeCoordsExtra(12,:)=[0.0344828_CMFEDP,0.15_CMFEDP,-0.5_CMFEDP]
  
  NodeCoordsExtra(13,:)=[0.0_CMFEDP,0.05_CMFEDP,-0.7_CMFEDP]
  NodeCoordsExtra(14,:)=[0.0344828_CMFEDP,0.05_CMFEDP,-0.7_CMFEDP]
  NodeCoordsExtra(15,:)=[0.0_CMFEDP,0.15_CMFEDP,-0.7_CMFEDP]
  NodeCoordsExtra(16,:)=[0.0344828_CMFEDP,0.15_CMFEDP,-0.7_CMFEDP]      
        
  DO node_idx=TotalNumberOfNodes+1,TotalNumberOfNodes+16
    CALL cmfe_Decomposition_NodeDomainGet(Decomposition,node_idx,1,NodeDomain,Err)
    IF(NodeDomain==ComputationalNodeNumber) THEN
      CALL cmfe_Field_ParameterSetUpdateNode(GeometricField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1, &
        & node_idx,1,NodeCoordsExtra(node_idx-TotalNumberOfNodes,2),Err) !x-positon
      CALL cmfe_Field_ParameterSetUpdateNode(GeometricField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1, &
        & node_idx,2,NodeCoordsExtra(node_idx-TotalNumberOfNodes,3),Err) !y-position
      CALL cmfe_Field_ParameterSetUpdateNode(GeometricField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1, &
        & node_idx,3,NodeCoordsExtra(node_idx-TotalNumberOfNodes,4),Err) !z-position
    ENDIF
  ENDDO      
