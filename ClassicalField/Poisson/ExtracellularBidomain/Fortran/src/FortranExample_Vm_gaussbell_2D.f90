...
!  USE CONSTANTS   !for pi
  ...
  REAL(CMFEDP), PARAMETER :: WIDTH=8.0_CMFEDP   ! x-direction
...
!  REAL(CMFEDP) :: ANALYTICAL_SOL_X_Y,CALCULATED_SOLUTION_X_Y,NODAL_ERROR,TOTAL_ERROR_SQUARED,DX,DY,DZ,ERROR_L2
  REAL(CMFEDP) :: FibreFieldAngle(3),Vm(33)
...
! SOURCE
  ...
  !Vm \in [0,100]  
!  Vm=[0.0_CMFEDP,0.0_CMFEDP,0.0_CMFEDP,0.0_CMFEDP,0.0_CMFEDP,0.0012_CMFEDP,0.0085_CMFEDP,0.0504_CMFEDP,0.2479_CMFEDP, &
!    & 1.0115_CMFEDP,3.4218_CMFEDP,9.5967_CMFEDP,22.3130_CMFEDP,43.0095_CMFEDP,68.7289_CMFEDP,91.0510_CMFEDP,100.0_CMFEDP, &
!    & 91.0510_CMFEDP,68.7289_CMFEDP,43.0095_CMFEDP,22.3130_CMFEDP,9.5967_CMFEDP,3.4218_CMFEDP,1.0115_CMFEDP, &
!    & 0.2479_CMFEDP,0.0504_CMFEDP,0.0085_CMFEDP,0.0012_CMFEDP,0.0_CMFEDP,0.0_CMFEDP,0.0_CMFEDP,0.0_CMFEDP,0.0_CMFEDP]

  !Vm \in [-70,30]      
  Vm=[-70.0_CMFEDP,-70.0_CMFEDP,-70.0_CMFEDP,-70.0_CMFEDP,-70.0_CMFEDP,-69.9988_CMFEDP,-69.9915_CMFEDP,-69.9496_CMFEDP, &
    & -69.7521_CMFEDP, &
    & -68.9885_CMFEDP,-66.5782_CMFEDP,-60.4033_CMFEDP,-47.687_CMFEDP,-26.9905_CMFEDP,-1.2711_CMFEDP,21.051_CMFEDP, &
    & 30.0_CMFEDP, &
    & 21.051_CMFEDP,-1.2711_CMFEDP,-26.9905_CMFEDP,-47.687_CMFEDP,-60.4033_CMFEDP,-66.5782_CMFEDP,-68.9885_CMFEDP, &
    & -69.7521_CMFEDP,-69.9496_CMFEDP,-69.9915_CMFEDP,-69.9988_CMFEDP,-70.0_CMFEDP,-70.0_CMFEDP,-70.0_CMFEDP,-70.0_CMFEDP, &
    & -70.0_CMFEDP]    
...
!!  CALL cmfe_Decomposition_NodeDomainGet(Decomposition,365,1,NodeDomain,Err)
!!  IF(NodeDomain==ComputationalNodeNumber) THEN
!!    CALL cmfe_Field_ParameterSetUpdateNode(SourceField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1, &
!!      & 1,365,1,100.0_CMFEDP,Err)
!!  ENDIF
!  
!  CALL cmfe_Decomposition_NodeDomainGet(Decomposition,TotalNumberOfNodes,1,NodeDomain,Err)
!  IF(NodeDomain==ComputationalNodeNumber) THEN
!    CALL cmfe_Field_ParameterSetUpdateNode(SourceField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1, &
!      & 1,TotalNumberOfNodes,1,5.0_CMFEDP,Err)
!  ENDIF
